    ...
    <div class="py-12">
        ...
        <form class="max-w-md mx-auto">
            <div class="relative z-0 w-full mb-5 group">
                <input type="rname" name="rname" id="rname" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent 
                ...
                <label for="rname" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 
                ...
                peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Название рубрики</label>
            </div>
        <div class="relative z-0 w-full mb-5 group">
            <input type="rdescription" name="rdescription" id="rdescription" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2
            ...
            <label for="rdescription" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 
